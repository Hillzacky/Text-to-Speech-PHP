...
{   
    ...
    public function upgrade(Request $request)
    {
        ...
        if (config('app.version') == 'v1.5') {
            ...
            return redirect()->back()->with('error', 'You are running a version older than v1.5, refer to the documentation to manually update to v1.5 first.');
        }
