...
function insertNewRow(input_text="") {
    ...
    let newRow = '<div class="textarea-row" id="' + newID + '">' +
                    ...
                    '<div class="textarea-text">' +
                        '<textarea class="form-control textarea" id="' + newID + 'Z" data-voice="' + textarea_voice_id + '" onkeyup="countCharacters();" onmousedown="mouseDown(this);" name="textarea[]" rows="1" maxlength="3000">' + input_text + '</textarea>' +
                    '</div>' +
...
function processText(text) {
    ...
    if (text.length > text_length_limit) {
        ...
        let text_chunks = chunkString(text, 3000);
