				...
				<div class="card-body">
					<div class="row text-center justify-content-md-center">
						<div class="col-md-5 col-sm-12 referral-box special-shadow mr-5 mb-4">
							...
							<a class="fs-12 font-weight-bold" href="{{ route('admin.referral.top') }}">{{ __('Top Referrers') }}</a>
						</div>
						<div class="col-md-5 col-sm-12 referral-box special-shadow mr-0 ml-2 mb-4">
							<div><i class="mdi mdi-account-multiple-plus"></i></div>
							<a class="fs-12 font-weight-bold" href="{{ route('admin.referral.registration') }}">{{ __('Referral Registrations') }}</a>
						</div>
					</div>
				</div>
			</div>
