				...
				<div class="card-body">
					...
					<form action="{{ route('admin.settings.frontend.store') }}" method="POST" enctype="multipart/form-data">
						...
						<div class="row">
							...
							<div class="col-md-4 col-sm-12">									
								<h6 class="fs-12 font-weight-bold mb-4">{{ __('Pricing Page') }}</h6>								
								<div class="form-group">
									<label class="custom-switch">
							...
							<div class="col-md-4 col-sm-12">									
								<h6 class="fs-12 font-weight-bold mb-4">{{ __('Voices Page') }}</h6>								
								<div class="form-group">
									<label class="custom-switch">
										<input type="checkbox" name="voices" class="custom-switch-input" @if ( config('frontend.voices_section')  == 'on') checked @endif>
										<span class="custom-switch-indicator"></span>
										<span class="custom-switch-description">{{ __('Show') }}</span>
									</label>
								</div> 
							...
							<div class="col-md-4 col-sm-12">									
								<h6 class="fs-12 font-weight-bold mb-4">{{ __('Contact Us Page') }}</h6>								
								<div class="form-group">
									<label class="custom-switch">
							...
							<div class="card-body">
								...
								<div class="row">
									<div class="col-md-12 col-sm-12">													
										<div class="input-box">								
											<h6>{{ __('Landing Page URL') }} <i class="ml-2 fa fa-info info-notification" data-tippy-content="Set custom index url for all frontend pages. Ex: https://aws.amazon.com (Note: https:// - is required)"></i></h6>
											<div class="form-group">							    
						...
						<div class="card border-0 special-shadow">							
							<div class="card-body">
								...
								<div class="row">
									...
									<div class="col-lg-6 col-md-6 col-sm-12">					
										<div class="input-box">								
											<h6><i class="fa-brands fa-google mr-2"></i>Google <span class="text-muted"></span></h6>
											<div class="form-group">							    
									...
									<div class="col-lg-6 col-md-6 col-sm-12">					
										<div class="input-box">								
											<h6><i class="fa-brands fa-youtube mr-2"></i>Youtube <span class="text-muted"></span></h6>
											<div class="form-group">							    
									...
									<div class="col-lg-6 col-md-6 col-sm-12">					
										<div class="input-box">								
											<h6><i class="fa-brands fa-vimeo mr-2"></i>Vimeo <span class="text-muted"></span></h6>
											<div class="form-group">							    
									...
									<div class="col-lg-6 col-md-6 col-sm-12">					
										<div class="input-box">								
											<h6><i class="fa-brands fa-flickr mr-2"></i>Flickr <span class="text-muted"></span></h6>
											<div class="form-group">							    
