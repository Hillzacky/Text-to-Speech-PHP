	...
	<div class="page-header mt-5-7">
		<div class="page-leftheader">
			...
			<ol class="breadcrumb mb-2">
				...
				<li class="breadcrumb-item active" aria-current="page"><a href="{{url('#')}}"> {{ __('New Review') }}</a></li>
			</ol>
		</div>
	</div>
	<!-- END PAGE HEADER -->
					...
					<form id="" action="{{ route('admin.settings.review.store') }}" method="post" enctype="multipart/form-data">
						...
						<div class="row mt-2">							
							<div class="col-lg-12 col-md-12 col-sm-12">							
								<div class="input-box">								
									<h6>{{ __('Customer Name') }} <span class="text-muted">({{ __('Required') }})</span></h6>
							...
							<div class="col-lg-6 col-md-6 col-sm-12">
								<div class="input-box">
									<h6>{{ __('Customer Avatar') }} <span class="text-muted">({{ __('Required') }})</span></h6>
						...
						<div class="row mt-2">
							<div class="col-lg-12 col-md-12 col-sm-12">	
								<div class="input-box">	
									<h6>{{ __('Review Text') }} <span class="text-muted">({{ __('Required') }})</span></h6>							
