				...
				<div class="card-body pt-5">
					...
					<div class="row">
						<div class="col-lg-4 col-md-4 col-12">
							...
							<span class="fs-14 text-primary font-weight-bold">{{ strtoupper($id->vendor) }}</span>
						</div>
						<div class="col-lg-4 col-md-4 col-12">
					...
					<div class="row pt-4">
						<div class="col-12">
							<div class="actions-total text-right">
								<a href="mailto:?subject=Text Synthesize Result&body=@if($id->storage == 'local'){{URL::asset($id->result_url)}} @else {{$id->result_url}} @endif" class="btn actions-total-buttons" id="actions-email" data-tippy-content="Share via Email"><i class="fa fa-at"></i></a>
								...
								<a href="" class="btn actions-total-buttons" id="actions-copy" data-link="@if($id->storage == 'local') {{ URL::asset($id->result_url) }} @else {{ $id->result_url }} @endif" data-tippy-content="Copy Download Link"><i class="fa fa-link"></i></a>	
							</div>
						</div>
					</div>
