						...
						<div class="card border-0 special-shadow">							
							<div class="card-body">
								...
								<div class="row">
									...
									<div class="col-lg-6 col-md-6 col-sm-12">									
										<div class="input-box">								
											<h6>{{ __('User All Voices Panel') }}</h6>
											<select id="user-voices" name="user-voices" data-placeholder="Enable/Disable User All Voices Panel">	
												<option value="enabled" {{ (config('settings.user_voices') == 'enabled') ? 'selected' : '' }}>{{ __('Enable') }}</option>
												<option value="disabled" {{ (config('settings.user_voices') == 'disabled') ? 'selected' : '' }}>{{ __('Disable') }}</option>																		
											</select> 
										</div> 
									</div>
								</div>
