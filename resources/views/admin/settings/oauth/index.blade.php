				...
				<div class="card-body">
					...
					<form action="{{ route('admin.settings.oauth.store') }}" method="POST" enctype="multipart/form-data">
						...
						<div class="card border-0 special-shadow">							
							<div class="card-body">
								<h6 class="fs-12 font-weight-bold mb-4"><i class="fs-13 mr-2 fa-brands fa-facebook-square"></i>Facebook</h6>
						...
						<div class="card border-0 special-shadow">							
							<div class="card-body">
								...
								<h6 class="fs-12 font-weight-bold mb-4"><i class="fs-13 mr-2 fa-brands fa-twitter-square"></i>Twitter</h6>
						...
						<div class="card overflow-hidden border-0 special-shadow">							
							<div class="card-body">
								...
								<h6 class="fs-12 font-weight-bold mb-4"><i class="fs-13 mr-2 fa-brands fa-google-plus-square"></i>Google</h6>
						...
						<div class="card overflow-hidden border-0 special-shadow">							
							<div class="card-body">
								...
								<h6 class="fs-12 font-weight-bold mb-4"><i class="fs-13 mr-2 fa-brands fa-linkedin-square"></i>LinkedIn</h6>
