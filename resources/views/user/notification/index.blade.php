	...
	<div class="page-header mt-5-7">
		<div class="page-leftheader">
			...
			<ol class="breadcrumb mb-2">
				<li class="breadcrumb-item"><a href="{{route('user.tts')}}"><i class="fa-solid fa-message-exclamation mr-2 fs-12"></i>{{ __('User') }}</a></li>
					...
					if (result.isConfirmed) {
						...
						$.ajax({
							...
							success: function (data) {
								if (data == 'success') {
									Swal.fire('Notification Deleted', 'Notification has been successfully deleted', 'success');	
									$("#notificationsTable").DataTable().ajax.reload();								
								} else {
									Swal.fire('Delete Failed', 'There was an error while deleting this notification', 'error');
								}      
							},
							error: function(data) {
