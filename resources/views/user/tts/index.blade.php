...
<div class="page-header mt-5-7">
	<div class="page-leftheader">
		...
		<ol class="breadcrumb mb-2">
			<li class="breadcrumb-item"><a href="{{route('user.tts')}}"><i class="fa-solid fa-wand-sparkles mr-2 fs-12"></i>{{ __('User') }}</a></li>
							...
							@if (config('tts.ssml_effect') == 'enable')
								<div class="row mb-6">
									<div class="col-md col-sm-12 special-buttons" id="style-box">
										<div class="dropdown">
											<button class="btn btn-special dropdown-toggle" type="button" id="speakingStyle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
											{{ __('Speaking Style') }}
											</button>
									...
									<div class="col-md col-sm-12 special-buttons" id="azurepause-box">
										<div class="dropdown">
											<button class="btn btn-special dropdown-toggle" type="button" id="azurePause" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
											{{ __('Pauses') }}
											</button>
