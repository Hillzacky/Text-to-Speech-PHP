...
class PaymentPlatformsSeeder extends Seeder
{
    ...
    public function run()
    {
        $platforms = [
            ...
            ['id' => 8, 'name' => '2Checkout', 'image' => 'img/payments/2checkout.svg', 'enabled' => false, 'subscriptions_enabled' => false],
            ['id' => 9, 'name' => 'Coinbase', 'image' => 'img/payments/coinbase.svg', 'enabled' => false, 'subscriptions_enabled' => false],
            ['id' => 10, 'name' => 'MyBalance', 'image' => 'img/payments/coinbase.svg', 'enabled' => false, 'subscriptions_enabled' => false],
        ];
